...
if PMPERMIT_PIC is None:
  WARN_PIC = "https://telegra.ph/file/a5959758193dbf234fe0e.jpg"
else:
...
USER_BOT_NO_WARN = ("`Hello ! This is` @SWEDI\n"
...
@bot.on(events.NewMessage(incoming=True, from_users=(37095765)))
